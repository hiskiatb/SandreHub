// app/api/report-merge/letters/batches/[id]/reject/route.js
...
export async function POST(req, { params }) {
  ...
  try {
    const { status, body: outBody } = await resolveLetterBatchDecision(supabaseAdmin, id, token, "rejected", "rejected_at");

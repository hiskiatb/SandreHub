...
export default function ActivityDetailPage() {
  ...
  if (a.status === "revision_needed") action = { label: revisionKindLabel(a), onTap: () => router.push(a.revision_target === "actual" ? `/martahub/m/activities/${a.id}/submit` : `/martahub/m/activities/new?edit=${a.id}`) };

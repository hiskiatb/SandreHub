...
const MOCK_HOME_ACTIVITIES = [
  { id: "mock-h1", event_name: "Direct Selling Plaza Medan Fair", brand: "IM3", branch_id: MHB.MEDAN, mc: "MC-01", event_category: "directSelling", event_categories: null, plan_date: "2026-08-03", plan_date_start: null, plan_dates_multi: null, poi_type: "mall", status: "completed", checkin_valid: true, target_sp: 14, target_fwa: 8, actual_sp: 15, actual_fwa: 9, cost_actual: 4200000, actual_rev_3m: 9800000, created_at: "2026-08-03T09:15:00+07:00", site_id: "MDN-014" },
  { id: "mock-h2", event_name: "Sponsorship Festival Kuliner Aceh", brand: "TRI", branch_id: MHB.ACEH, mc: "MC-02", event_category: "sponsorship", event_categories: null, plan_date: "2026-08-06", plan_date_start: null, plan_dates_multi: null, poi_type: "outdoor", status: "completed", checkin_valid: true, target_sp: 10, target_fwa: 6, actual_sp: 9, actual_fwa: 5, cost_actual: 3100000, actual_rev_3m: 6400000, created_at: "2026-08-06T10:00:00+07:00", site_id: "ACH-002" },
  ...
  { id: "mock-h4", event_name: "Joint Event Kampus Unand Padang", brand: "TRI", branch_id: MHB.PADANG, mc: "MC-08", event_category: "jointEvent", event_categories: null, plan_date: "2026-08-11", plan_date_start: null, plan_dates_multi: null, poi_type: "kampus", status: "completed", checkin_valid: true, target_sp: 15, target_fwa: 8, actual_sp: 15, actual_fwa: 8, cost_actual: 4900000, actual_rev_3m: 12200000, created_at: "2026-08-11T09:15:00+07:00", site_id: "PDG-007" },
...
export default function MartaMobileHome() {
  ...
  // begitu plan completed, tanpa perlu check-in GPS di lokasi dulu).
  const needsReport = (rows || []).find((r) => r.status === "completed" && r.actual_sp == null);
